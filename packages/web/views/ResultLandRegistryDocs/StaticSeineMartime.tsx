...
export const StaticSeineMartime = (): JSX.Element => (
  <>
    ...
    <p>
      ...
      cadastrale écrite jusqu'à une date comprise entre 1931 et 1963 selon la
      commune concernée.
    </p>
    ...
    <TITLES.H2>Après 1963</TITLES.H2>

    <p>
      Pour consulter les documents postérieurs, il convient de s’adresser à la
